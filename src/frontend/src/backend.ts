...
export class Backend implements backendInterface {
    ...
    async getCategoryLeaderboard(arg0: Category): Promise<Array<Score>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCategoryLeaderboard(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitScore(arg0: string, arg1: ScoreValue, arg2: Category): Promise<void> {
        if (this.processError) {
            try {
